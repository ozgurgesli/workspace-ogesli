...
cprequire_test(["inline:com-chilipeppr-workspace-ogesli"], function(ws) {
    ...
    $('title').html("Ogesli Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-ogesli", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-ogesli", // Make the id the same as the cpdefine id
        name: "Workspace / OGesli", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace Ogesli.`,
...
//            this.loadTemplateWidget();    // commented out by ozgur
        ...
        loadGGButtonPanelWidget: function(callback) {
            ...
            chilipeppr.load(
              "#com-ozgurgesli-widget-gg-button-panel-instance",
              ...
              function() {
                ...
                cprequire(
                  ...
                  function(myObjComOzgurgesliWidgetGgButtonPanel) {
                    // Callback that is passed reference to the newly loaded widget
                    console.log(".", myObjComOzgurgesliWidgetGgButtonPanel);
            ...
            /**
         * Load the cnc controller widget?
         */
        loadTinyGlWidget: function(callback) {
